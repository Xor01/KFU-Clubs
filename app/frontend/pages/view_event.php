<div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
  <div class="my-3 p-3">
    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <a href="view_event.php?user_id=<?= $user->data()->uid?>&event_id=<?=$events->data()[0]->eventID?>&club_id=<?=$events->data()[0]->clubID?>&action=register" class="btn btn-outline-success btn-block">Register</a>
      </div>
      <div class="col-md-4">
      ...
      <div class="card-body p-4">
        <div data-mdb-input-init class="form-outline mb-4">
          ...
          <div class="input-group">
            <input type="text" id="addANote" class="form-control" placeholder="Type comment..." <?php if(!$event_is_over) {echo "disabled";}?> />
            <button type="button" class="btn btn-outline-secondary <?php if(!$event_is_over) {echo "disabled";}?>">Send</button>
          </div>
        </div>
      </div>
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between">
            <div class="d-flex flex-row align-items-center">
              <p class="small mb-0 ms-2">From: Commenter name is here</p>
            </div>
            <div class="d-flex flex-row align-items-center">
